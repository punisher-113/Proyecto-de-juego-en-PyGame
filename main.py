...
sound2: SoundType = pygame.mixer.Sound("musica/sawdemons.ogg")
sound2.set_volume(0)
sound2.play()


sound3: SoundType = pygame.mixer.Sound("musica/cultbasedoom.ogg")
sound3.set_volume(0)
sound3.play()
...
background3 = pygame.image.load("assets/fondo/fondo5.jpg").convert()
...
class GameState():
    ...
    def state_manager(self):
        ...
        if 0 <= self.score < 700 or self.state=="lvl1":
            self.lvl1()

        if 700 <= self.score < 1500:
            self.state = "lvl2"
        if self.state =="lvl2":
            self.lvl2()
